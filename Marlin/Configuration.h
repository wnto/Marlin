...
#define STRING_CONFIG_H_AUTHOR "(fb, Anet config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "A8 box"
...
// For the other hotends it is their distance from the extruder 0 hotend. //check fb deveria verificar se as distâncias estão corretas
 ...
 */
#define TEMP_SENSOR_0 5 // mudado 1 para 5
...
#define TEMP_SENSOR_BED 5 // mudado 1 para 5
#define TEMP_SENSOR_PROBE 0
#define TEMP_SENSOR_CHAMBER 0 //check posso instalar no futuro
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  34.74 //fb três valores 20240404
    #define DEFAULT_Ki   3.07
    #define DEFAULT_Kd  98.07
  #endif
#else
...
#define Y_MAX_ENDSTOP_HIT_STATE LOW // check mudei
...
#define Z_MIN_PROBE_ENDSTOP_HIT_STATE LOW  //check no exemplo Anet tá low.

// Enable this feature if all enabled endstop pins are interrupt-capable.
// This will remove the need to poll the interrupt pins, saving many CPU cycles.
#define ENDSTOP_INTERRUPTS_FEATURE //edp
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 400, 400, 8, 150 }
 ...
 */
#define DEFAULT_ACCELERATION           400 //edp 3000    // X, Y, Z and E acceleration for printing moves
...
#define Z_AFTER_HOMING         3   // (mm) Height to move to after homing (if Z was homed)
 ...
 */
#define RESTORE_LEVELING_AFTER_G28 //edp
//#define ENABLE_LEVELING_AFTER_G28 //check - seria melhor?
...
//#define LCD_BED_TRAMMING //check - ativar, se possível
...
#define HOMING_FEEDRATE_MM_M { (100*60), (100*60), (4*60) } //{ (50*60), (50*60), (4*60) }
 ...
 */
//#define NOZZLE_PARK_FEATURE // //check no exemplo Anet tá ativado
...
//
//#define REVERSE_ENCODER_DIRECTION  //check no exemplo Anet tá ativado.
...
//
#define REPRAP_DISCOUNT_FULL_GRAPHIC_SMART_CONTROLLER //edp
...
//
//#define ANET_FULL_GRAPHICS_LCD //check com configuration file de exemplo do github. e linhas acima
